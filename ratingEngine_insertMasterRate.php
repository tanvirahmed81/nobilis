...
//echo '<pre>Surcharges '; print_r($surchargesArr); echo '</pre>'; 
//echo '<pre>Deductible '; print_r($deductibleArr); echo '</pre>';
//exit();
 	...
 	else 
 	{
 		if(strlen(trim($uploaded_file)))
  		{	 	
			...
			{    
				$html.= "<span style='font-weight:bold; font-size:15px;'><a href='view_ratecard_details.php?ratecard_num=$upload_code&master_rate_id=$master_rate_id'>View Rate Card</a> </strong> <br /> <br />";
			}   
...
header("Location: ratingEngine_search.php?ratecard_num=$upload_code&$param");
